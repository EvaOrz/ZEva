 ...
 */
public class StudyingClassInfoApi extends BaseApi {
    private Activity activity;
    private ResponseCallBack<ClassModel> callBack;
    private String url;

    public StudyingClassInfoApi(Activity context, String kid, ResponseCallBack<ClassModel> callBack) {
        super(context);
        this.activity = context;
        url = UrlUtil.traceClassDetail() + "?kid=" + kid;
