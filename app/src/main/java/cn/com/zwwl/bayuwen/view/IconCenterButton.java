 ...
 */
public class IconCenterButton extends android.support.v7.widget.AppCompatTextView {
    ...
    public IconCenterButton(Context context, AttributeSet attrs, int defStyle) {
