...
public class TCourseListAdapter extends BaseRecylcerViewAdapter<TeacherDetailModel.CoursesEntity> {
    public TCourseListAdapter(Context mContext, List<TeacherDetailModel.CoursesEntity> list) {
        super(mContext, list);
    }

    @NonNull
    @Override
    public TCourseListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new TCourseListAdapter.ViewHolder(inflater.inflate(R.layout.item_course_list, parent, false));
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        viewHolder.fcplaceTv.setText(list.get(position).getSchool());
        viewHolder.fctimeTv.setText(list.get(position).getStart_at() + "至" + list.get(position).getEnd_at());
