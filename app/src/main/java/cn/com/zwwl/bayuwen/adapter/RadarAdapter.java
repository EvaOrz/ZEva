...
public class RadarAdapter extends BaseQuickAdapter<CommonModel, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, CommonModel item) {
        ...
        } else if (helper.getLayoutPosition() == 10 || helper.getLayoutPosition() == 20 || helper.getLayoutPosition() == 30) {
            imageView.setImageResource(R.mipmap.pt_04);
        } else if (helper.getLayoutPosition() == 19 || helper.getLayoutPosition() == 29 || helper.getLayoutPosition() == 39) {
