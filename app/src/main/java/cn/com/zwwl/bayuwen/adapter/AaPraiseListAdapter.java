 ...
 * Created by lousx
 */
public class AaPraiseListAdapter extends BaseRecylcerViewAdapter<PraiseModel.TutorsEntity> {
    private Context mContext;

    public AaPraiseListAdapter(Context mContext, List<PraiseModel.TutorsEntity> list) {
        super(mContext, list);
    ...
    @NonNull
    @Override
    public AaPraiseListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new AaPraiseListAdapter.ViewHolder(inflater.inflate(R.layout.item_praise, parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        PraiseModel.TutorsEntity item = list.get(position);
        final AaPraiseListAdapter.ViewHolder viewHolder = (AaPraiseListAdapter.ViewHolder) holder;
