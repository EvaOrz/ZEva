...
public class FmLoginActivity extends BaseActivity {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.login_register:
                startActivity(new Intent(FmLoginActivity.this, FmRegisterActivity.class));
                break;
            ...
            case R.id.forget_pwd:
                startActivity(new Intent(FmLoginActivity.this, FmForgetPwdActivity.class));
                break;
