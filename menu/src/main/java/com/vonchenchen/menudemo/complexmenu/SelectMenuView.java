package com.vonchenchen.menudemo.complexmenu;
...
import com.vonchenchen.menudemo.complexmenu.holder.SelectHolder;
import com.vonchenchen.menudemo.complexmenu.holder.SortHolder;
import com.vonchenchen.menudemo.complexmenu.holder.SubjectHolder;
...
public class SelectMenuView extends LinearLayout{
    ...
    private static final int TAB_GRADE = 4;
...
//        });
    ...
    private void handleClickGradeView(){
        ...
        mMainContentLayout.removeAllViews();
        mMainContentLayout.addView(mSortHolder3.getRootView(), ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    private void handleClickSelectView(){
        ...
        mMainContentLayout.removeAllViews();
        mMainContentLayout.addView(mSortHolder2.getRootView(), ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
    ...
    private void resetTabExtend(int tab){
        if(tab == TAB_SUBJECT){
            ...
            gradeTv.setTextColor(getResources().getColor(R.color.gray));
    ...
    private void setTabClose(){
        ...
        gradeTv.setTextColor(getResources().getColor(R.color.text_color_gey));
        img_sub_grade.setImageResource(R.mipmap.ic_down);
    }
